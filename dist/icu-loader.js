(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("icu-loader", [], factory);
	else if(typeof exports === 'object')
		exports["icu-loader"] = factory();
	else
		root["icu-loader"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (exports) {
	  exports.date = {
	    toLocaleString: function toLocaleString(params) {
	      return __webpack_require__(1).default(params, 'toLocaleString');
	    },
	    toLocaleDateString: function toLocaleDateString(params) {
	      return __webpack_require__(1).default(params, 'toLocaleDateString');
	    },
	    toLocaleTimeString: function toLocaleTimeString(params) {
	      return __webpack_require__(1).default(params, 'toLocaleTimeString');
	    }
	  };
	  exports.string = {
	    localeCompare: function localeCompare(params) {
	      return __webpack_require__(4).default(params);
	    }
	  };
	  exports.number = {
	    toLocaleString: function toLocaleString(params) {
	...
	})( false ? undefined['icu-loader'] = {} : exports);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	exports.default = function (parameters /* : any */, functionName /* : string */) {
	  // Check out empty object or inadequacy of the parameters
	  if (_lodash2.default.isEmpty(parameters) || !parameters.length) {
	    throw Error('Parameters are empty or not enough!');
	  }
	
	  var object /* : any */ = parameters[0];
	  var locales /* : string */ = parameters[1] ? parameters[1].value : 'en-US'; // 'en-US' as default locale
	  var options /* : any */ = parameters[2] ? parameters[2].value : {};
	  var output /* : string */ = '';
	
	  // Check out type of object parameter
	  if (object.type === 'object' && !_lodash2.default.isNaN(new Date(object.value).getMonth())) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	exports.default = function (object /* : any */) {
	  // Check out emoty object or inadequacy of the parameters
	  if (_lodash2.default.isEmpty(object) || object.length < 2) {
	    throw Error('Parameters are empty or not enough!');
	  }
	
	  var referenceStr /* : string */ = object[0];
	  var compareString /* : string */ = object[1];
	  var locales /* : string */ = object[2];
	  var options /* : any */ = object[3];
	
	  // Comaring Strings
	  var output = referenceStr.localeCompare(compareString, locales, options);
...
;
//# sourceMappingURL=icu-loader.js.map